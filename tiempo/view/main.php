  ...
  <div class="col-xs-12">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="row mb-1">
          <div class="col-xs-12">
            <button class="btn btn-info" data-toggle="collapse" data-target="#formBase"> <span class="caret"></span> Añadir Tiempo</button>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-8">
              <div class="form-group">
                <label for="nombre"> Nombre del Tiempo </label>
                <input type="text" name="nombre" class="form-control" placeholder="Ingrese el nombre del tiempo" required maxlength="150" />
              </div>
            </div>
        ...
        <h4 class="text-muted">Lista de Tiempos</h4>
...
(function(){
  ...
  var insertBase = function(ev){
    ...
    if( value.length === 0 ){
      Swal.fire("Error", 'El nombre para el tiempo es requerido', 'warning');
      return;
    }

    Swal.fire({
      title: 'Agregar tiempo',
      text: '¿Desea agregar el tiempo ' + value + '?',
      icon: 'question',
  ...
  $("#tabla_base").on('click', 'button', function(ev){
    ...
    if( this.classList.contains('edit') ){
      ...
      Swal.fire({
        ...
        text: 'ingrese el nombre del tiempo',
        input: 'text',
        ...
        inputPlaceholder: 'Nuevo nombre del tiempo',
      ...
      Swal.fire({
        title: 'Eliminar el tiempo',
        text: '¿Desea eliminar el tiempo ' + data.descripcion + '?',
        icon: 'question',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        ...
        if (result.value) {
          ...
          $.ajax({
            ...
            type: 'POST',
            dataType: 'json',
            data: {method: 'delBase', id: data.idTiempo},
            beforeSend: ()=>{
              Swal.fire({
                title: 'Eliminando',
                onOpen: ()=>{
