  ...
  <div class="col-xs-12">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-heading bg-coral text-white text-center">
        <h3 class="panel-title"> <i class="fa fa-pie-chart"></i> Lineas </h3>
      </div>
      ...
      <div class="panel-body">
        ...
        <div class="row mb-1">
          <div class="col-xs-12">
            <button class="btn btn-info" data-toggle="collapse" data-target="#formBase"> <span class="caret"></span> Añadir Linea</button>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-8">
              <div class="form-group">
                ...
                <input type="text" name="nombre" class="form-control" placeholder="Ingrese el nombre de la linea" required maxlength="150" />
              </div>
            </div>
        ...
        <h4 class="text-muted">Lista de Lineas</h4>
...
(function(){
  ...
  var insertBase = function(ev){
    ...
    if( value.length === 0 ){
      Swal.fire("Error", 'El nombre para la linea es requerido', 'warning');
      return;
    }

    Swal.fire({
      title: 'Agregar Linea',
      text: '¿Desea agregar la linea ' + value + '?',
      icon: 'question',
  ...
  $("#tabla_base").on('click', 'button', function(ev){
    ...
    if( this.classList.contains('edit') ){
      ...
      Swal.fire({
        ...
        text: 'ingrese el nombre de la linea',
        input: 'text',
      ...
      Swal.fire({
        title: 'Eliminar la Linea',
        text: '¿Desea eliminar la Linea ' + data.descripcion + '?',
        icon: 'question',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        ...
        if (result.value) {
          ...
          $.ajax({
            ...
            type: 'POST',
            dataType: 'json',
            data: {method: 'delBase', id: data.idLinea},
            beforeSend: ()=>{
              Swal.fire({
                title: 'Eliminando',
                onOpen: ()=>{
