  ...
  <div class="col-xs-12">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-heading bg-coral text-white text-center">
        <h3 class="panel-title"> <i class="fa fa-pie-chart"></i> Grupos </h3>
      </div>
      ...
      <div class="panel-body">
        ...
        <div class="row mb-1">
          <div class="col-xs-12">
            <button class="btn btn-info" data-toggle="collapse" data-target="#formBase"> <span class="caret"></span> Añadir Grupo</button>
          </div>
        </div>
