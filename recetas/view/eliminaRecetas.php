<div class="row mt-20-px">
  ...
  <div class="col-xs-12">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-heading text-white text-center" style="background-color: #EE7561; ">Eliminar Recetas</div>
          ...
          <form action="#" method="POST" name="form_receta" id="form_receta">
            ...
            <div class="row my-1">
              <div class="col-xs-12 text-center">
                <button class="btn btn-danger" type="submit">Eliminar Receta</button>
              </div>
            </div>
...
(function(){
  ...
  formReceta.addEventListener('submit', deleteReceta);
