...
$clientePost = filter_input(INPUT_GET, 'cliente', FILTER_SANITIZE_STRING);
$unidadPost = filter_input(INPUT_GET, 'unidadCliente', FILTER_SANITIZE_STRING);
...
$sql = "SELECT me.idMenu, me.cliente, me.unidad, mr.receta, mr.fecha, me.grupo, mr.personas, mr.pos, mr.precio FROM menu as me inner join menurec as mr on me.idMenu = mr.idMenu WHERE ( mr.fecha between '{$start}' AND '$end' ) AND activo = 1 AND me.unidad = '{$unidadPost}'";
$r = $db->query($sql);
